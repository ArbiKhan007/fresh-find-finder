      ...
      const response = await fetch("http://localhost:8080/api/v1/shop/register", {
        ...
        body: JSON.stringify({
          shop: {
            ...
            pincode: parseInt(formData.shopPincode),
            addressLine1: formData.shopAddressLine1,
            addressLine2: formData.shopAddressLine2 || "",
            addressLine3: formData.shopAddressLine3 || "",
            phoneNumber: parseInt(formData.shopPhoneNumber),
          },
          shopkeeper: {
            name: formData.name,
